...
<div id="upload_bt" class="ds_tool_group" style="">
    <div id="dsbt_upload" href="#paletteContentUploads" class="paletteLabel upload ds_button dsbt {{ Session::has('user_ip')?'':'ds_active' }} " data-fancybox="modal">
    </div>
    <div id="dsbt_my_upload"  href="#paletteContentArrangements" class="paletteLabel style ds_button dsbt  {{ Session::has('user_ip')?'ds_active':'' }}"  data-fancybox="modal">
...
<div id="docBare" class="null cf">
	 <article id="bundleBody" class="designawall design">
			...
			<section id="contentContainer">
				<div id="editPageContainer" class="svg edit">
						...
						<div id="preview_box" style="display:none; padding:0;min-height: ">
								<button class="btn btn-4 btn-white" data-fancybox-close onclick="closePreview();" style="position: absolute;right: 5%;bottom: 15%;z-index:60;">Close</button>
								<div id="preview_content" style="margin:0;padding:0;border:0px;display:none;">
								</div>
								<div id="preview_image" style="margin:auto;padding:15px;border:0px;display:none;width: 100%;background:white;border:1px solid #ddd;">
			...
			<section id="navBarContainer">
				 ...
				 <p class="text-center">
				 	<a id="addToCartLink" class="btn btn-4 btn-white" onclick="addCart()">{{ $cartEdit ? 'Update' : 'Add to'}} Cart</a>
		...
		<script type="text/javascript">
			...
			function importPC(){
				...
				$("document").ready(function(){
						...
						$('.paletteLabel').on('touchend',function(){
						...
						$("#editAreaWorkArea").on("click",function(e){
