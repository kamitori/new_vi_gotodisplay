...
<div id="docBare" class="null cf">
	 <article id="bundleBody" class="cp designawall design">
			<section id="navBarContainer">
				 <div id="actionContainer">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;
						<a id="addToCartLink" class="btn btn-4 btn-white" onclick="addCart()">{{ $cartEdit ? 'Update' : 'Add to'}} Cart</a><a id="returnToCartLink" class="primaryButton hidden">Return to Cart</a>
				 </div>
			</section>
			...
			<section id="contentContainer" style="min-height:750px;">
				 <div id="paletteContainer">
						<div id="paletteContent">
								...
								<div id="paletteContentUploads"  class="paletteContent viSTPWide">
										<div class="row">
												<!-- <div class ="col-xs-6" >
														<img id         ="import_vi" src="/assets/images/social_icon/button-vi.png" style="width:100%; max-height: 70px;" alt="import_vi" title="From VI library" />
												</div> -->
												<div class      ="col-xs-6">
														<img onclick="importPC()" id         ="import_mpc" src="/assets/images/social_icon/mypc-upload.jpg" alt="import_mpc" style="width:100%; max-height: 70px;" title="Upload From PC" />
												</div>
												<div class      ="col-xs-6">
														<img onclick="importFB()" id         ="import_fb" src="/assets/images/social_icon/button-facebook.png" alt="import_fb" style="width:100%; max-height: 70px;" title="Facebook" />
												</div>
												<div class      ="col-xs-6">
														<img onclick="importFlickr()" id         ="import_flickr" src="/assets/images/social_icon/button-flickr.png" alt="import_flickr" style="width:100%; max-height: 70px;" title="Upload From Facebook" />
												</div>
												<div class      ="col-xs-6">
														<img onclick="importDropbox()" id         ="import_dropbox" src="/assets/images/social_icon/button-dropbox.png" alt="import_dropbox" style="width:100%; max-height: 70px;" title="Upload From DropBox" />
												</div>
												<div class      ="col-xs-6">
														<img onclick="importGoogledrive()" id         ="import_googledrive" src="/assets/images/social_icon/button-googledrive.png" alt="import_googledrive" style="width:100%; max-height: 70px;" title="Upload From Google Driver" />
												</div>
												<!-- <div class ="col-xs-6">
														<img id         ="import_picasa" src="/assets/images/social_icon/button-picasa.png" alt="import_picasa" style="width:100%; max-height: 70px;" title="Upload From Picasa" />
												</div> -->
												<div class      ="col-xs-6">
														<img onclick="importSkydrive()" id         ="import_skydrive" src="/assets/images/social_icon/button-skydrive.png" alt="import_skydrive" style="width:100%; max-height: 70px;" title="Upload From Skydrive" />
												</div>
												<div class      ="col-xs-6">
														<img onclick="importInstagram()" id         ="import_instagram" src="/assets/images/social_icon/button-instagram.png" alt="import_instagram" style="width:100%; max-height: 70px;" title="Upload From Instagram" />
												</div>
										</div>
							 ...
							 <div id="paletteContentBackgrounds" class="paletteContent" style="padding-left: 13px;padding-top: 15px;">
										...
										@endforeach
										<button style="margin-top:15px;" class="nicebt btn btn-4 btn-white" onclick="$('#background-upload').click();">Add your background images</button>
				 ...
				 <div id="editPageContainer" class="svg edit" style="width: 75%;min-height:100px;">
						<div id="editAreaToolBar" class="header" style="width: 100%;background: #431400;color: #fff;">
							...
							<div id="preview_bt" class="ds_tool_group ds_border_left right" style="display:block">
									<div id="zoom_bt" class="ds_tool_group" style="display:block">
										<div class="ds_button resetzoom" id="reset_zoom" onclick="resetSVG()" style="display:none">
							...
							<div id="zoom_bt2" class="ds_tool_group ds_border_left right" style="display:none">
									<div class="ds_button zoom_in" onclick="zoomInTheme()">
											<!-- <div class="ds_button_icon"><span class="glyph fa fa-search-plus"></span></div>
											<div class="ds_button_name">Zoom in</div> -->
									</div>
									<div class="ds_button zoom_out" onclick="zoomOutTheme()">
											<!-- <div class="ds_button_icon"><span class="glyph fa fa-search-minus"></span></div>
						...
						<div id="preview_box" style="display:none; padding:0;">
								<button class="btn btn-4 btn-white" onclick="closePreview();" style="position: absolute;right: 5%;bottom: 15%;z-index:60;">Close</button>
