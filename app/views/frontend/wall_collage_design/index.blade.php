	...
	<article id="bundleBody" class="cp designawall design">
		<section id="navBarContainer">
			...
			<div id="actionContainer">
				...
				<a id="addToCartLink" class="btn btn-4 btn-white" onclick="Main.addCart()">{{ isset($product['cart_id']) ? 'Update' : 'Add to'}} Cart</a><a id="returnToCartLink" class="primaryButton hidden">Return to Cart</a>
			</div>
		</section>
		<section id="contentContainer" style="min-height:750px;">
				...
				<div id="paletteContent">
					...
					<div id="pick_color" class="paletteContent" style="padding-left: 13px;padding-top: 15px;">
						...
						<div class="ChooseColor">
							...
							<div class="choiced_color_box" style="border:none;">
								<button id="btnChooseColor1" type="button" class="btn btn-4 btn-white" onclick="ColorPicker.close()">
			...
			<div id="editPageContainer" class="svg edit" style="width: 75%;min-height:100px;">
				...
				<div id="preview_box" style="display:none; padding:0; overflow: auto">
					<button class="btn btn-4 btn-white" onclick="Main.preview(false)" style="position: absolute;right: 5%;bottom: 15%;z-index:60;">Close</button>
