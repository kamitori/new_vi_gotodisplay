			...
			<div class="quick_design">
				<div class="header">
					...
					<div id="upload_bt" class="ds_tool_group" style="">
						<div id="dsbt_upload" class="upload ds_button dsbt {{ Session::has('user_ip')?'':'ds_active' }} " data-fancybox="modal" href="#content_upload" style="height:64px">
						</div>
						<div id="dsbt_my_upload" class="my_upload ds_button dsbt  {{ Session::has('user_ip')?'ds_active':'' }}" data-fancybox="modal" href="#content_my_upload" style="height:64px">
							<!-- <div class="ds_button_icon" style="color:green;"><i class="fa fa-fw fa-picture-o"></i></div>
							<div class="ds_button_name">My upload</div> -->
						</div>
						<div id="dsbt_layout_size" class=" size ds_button dsbt" data-fancybox="modal" href="#content_layout_size" style="height:64px">
						...
						<div id="dsbt_style" class="style ds_button dsbt" data-fancybox="modal" href="#content_style" style="height:64px">
						...
						<div id="dsbt_frame_depth" class="depth ds_button dsbt" data-fancybox="modal" href="#content_frame_depth" style="height:64px">
						...
						<div id="dsbt_border" class="border ds_button dsbt" data-fancybox="modal" href="#content_border" style="height:64px">
						...
						?>
						@if( $optionShow > 0 )
						<!-- <div id="dsbt_option" class=" option ds_button dsbt" data-fancybox="modal" href="#content_option" style="display:none">
				...
				<div id="image_bt" class="ds_tool_group" style="display:none;">
						<div id="dsbt_filter" data-fancybox="modal" href="#content_filter" class="filter ds_button dsbt" style="height:64px">							
						</div>
						<div class="ds_button rotate" onclick="rotateImage()" style="height:64px">
						</div>
						<div class="ds_button rotate_frame"  onclick="rotateFrame()" style="height:64px">
						</div>
						<div class="ds_button flipx" onclick="flipImageX()" style="height:64px">
						</div>
						<div class="ds_button flipy" onclick="flipImageY()" style="height:64px">
						</div>
				...
				<div class="content" style="display:table;">
					...
					<div class="right_content">
						...
						<div id="svg_main" style="display:block;text-align: center;">
					...
					<div id="preview_bt" class="ds_tool_group right" style="display:block;position:relative;">
						<div id="zoom_bt" class="inline" style="display:none">
						...
						<div class="ds_button view3d" onclick="Preview3D()" data-fancybox="modal" href="#preview_box">
						...
						<div class="ds_button preview" onclick="Preview()" data-fancybox="modal" href="#preview_box">
						...
						<div class=" slider_bt" style="position: absolute;margin: 60px -40px 1px 33px;display:none;right: 45px;">
						...
						<div class=" slider_bt" style="position: absolute;margin: 216px -40px 155px 33px;display:none;right: 53px;color:white">
							<span style="width:54px;float:left;font-family:verdana;">Zoom</span>
							<div id="zoom-slider" style="margin: -1px 4px 4px 45px"></div>
						</div>
						@endif
					</div>
					
					<div class="left_content" style="padding-bottom: 15px;">
						<!-- Upload -->
						<div style="display: none;">
							<div id="content_upload" class="content_list" style="width:100%;">
								...
								<div id="import_image" style="margin-top:20px;">
										...
										<div class="col-xs-4" >
												<img id="import_fb" onclick="importFB()" src="/assets/images/social_icon/button-facebook.png" alt="" style="width:100%;" alt="Facebook" title="Facebook">
										</div>
										@endif
										@if(isset($arr_socail_id['flickr']))
										<div class="col-xs-4" >
												<img id="import_flickr" onclick="importFlickr()" src="/assets/images/social_icon/button-flickr.png" alt="" style="width:100%;" alt="Flickr" title="Flickr">
										</div>
										@endif
										@if(isset($arr_socail_id['dropbox']))
										<div class="col-xs-4" >
												<img id="import_dropbox"  onclick="importDropbox()" src="/assets/images/social_icon/button-dropbox.png" alt="" style="width:100%;" alt="Dropbox" title="Dropbox">
										</div>
										@endif
										@if(isset($arr_socail_id['googledrive']))
										<div class="col-xs-4" >
												<img id="import_googledrive" onclick="importGoogledrive()" src="/assets/images/social_icon/button-googledrive.png" alt="" style="width:100%;" alt="Goole Drive" title="Goole Drive">
										</div>
										<!-- <div class="col-xs-4" >
										...
										<div class="col-xs-4" >
												<img id="import_skydrive" onclick="importSkydrive()" src="/assets/images/social_icon/button-skydrive.png" alt="" style="width:100%;" alt="Skydrive or Onedrive" title="Skydrive or Onedrive">
										</div>
										@endif
										@if(isset($arr_socail_id['instagram']))
										<div class="col-xs-4" >
												<img id="import_instagram" onclick="importInstagram()" src="/assets/images/social_icon/button-instagram.png" alt="" style="width:100%;" alt="Instagram" title="Instagram">
										</div>
										@endif
						...
						<!-- My Upload -->
						<div id="content_my_upload" class="content_list content_3column" style="display:none;">
							...
							?>
								<div id="bleed_{{$key2}}" class="step3-options" style="display: block;">
									...
									<ul class="list-unstyled">
										...
										<li class="col2">
											<div class="float-L thumb-img item_{{$key2}}" <?php if(isset($dept_image[$key])) echo "style='background: url(".$dept_image[$key].") no-repeat 0px 0px; !important' " ?>
                                            ></div>
											<p class="price"></p>
										</li>
									</ul>
					...
					<div id="preview_box">
						...
						<div id="image_box" style="display:none;">
							<div id="img_precview" style="width:100%; margin:auto;display:block;">
								<img id="img_svg_precview" src="{{URL}}/assets/images/others/loading.gif" alt="title" style="max-height:500px;" />
							</div>
						</div>

						<button onclick="closePreview();" data-fancybox-close style="margin-top:15px;" class="btn btn-4 btn-white">Close</button>
					</div>
				...
				<div class="footer">
					...
					<div class="final_name">
						<h3 style="margin-top: 5px;margin-bottom: 5px; padding: 10px;">
							...
							<span id="name_bleed">
								@if( isset($arrbleeb[$product['bleed']]))
									- {{$arrbleeb[$product['bleed']]}}" depth 
								@endif
							 </span>
							<span class="check_quality"></span>
						...
						<p class="tetx-center col-xs-8 col-xs-offset-2" style="margin-top: 20px;">
							<button class="btn btn-4 btn-white btn-block btn-lg" onclick="addCart();"> {{ isset($svgInfo['cart_id']) ? 'Update' : 'Add to' }} cart </button>
						</p>
	...
	$("#dialog").on( "dialogclose", function( ) {
		...
		$("document").ready(function(){
			...
			$("#dsbt_filter").on('click',function(){
				if($("#content_filter").is(":visible")) $("#content_filter").hide();
				else $("#content_filter").show();
