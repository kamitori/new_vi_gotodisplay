...
<header>
    ...
    <a name="detail-achor"></a>
    <div class="previous-next row">
        <div class="previous columns large-3 small-6">
    		@if( !empty($product['prev_product']) )
            <span class="left">
            <a href="{{ URL.'/collections/'.$product['categories'][0]['short_name'].'/'.$product['prev_product']['short_name'] }}#detail-achor" title="{{ $product['prev_product']['name'] }}">
        ...
        <div class="next columns large-3 large-offset-6 small-6">
    		@if( !empty($product['next_product']) )
            <span class="right">
            <a href="{{ URL.'/collections/'.$product['categories'][0]['short_name'].'/'.$product['next_product']['short_name'] }}#detail-achor" title="{{ $product['next_product']['name'] }}">
...
<article class="row" itemscope="" itemtype="" id="detail">
            ...
            <div class="quanity-cart-row clearfix">
                <div class="variants vifull">
                    ...
                    <div class="selector-wrapper">
                        ...
                        <input id="quantity" type="number" min='1' step='1' class="calculate-price" name="quantity" value="1">
                    </div>
                </div>
                <div class="add-to-cart">
                    <input type="submit" name="quick_order" id="quick_order" value="Quick Upload and Order" class="button" style="display:block;">
                </div>
            </div>
            <div class="backorder">
                <p></p>
    ...
    <!-- .left-column -->
    <div class="middle-column photos left columns large-6 show-for-medium-up show-for-ie9-down" style="min-height: 365px;">
        <div class="container clearfix clickable">
            <img style="min-width:335px;" id="main-image" main-src="{{ $product['image'] }}" src="{{ $product['image'] }}" class="zoomImg">
        </div>
