            ...
            <div class="quick_design">
                <div class="header">
                    <div id="preview_bt" class="ds_tool_group ds_border_left right" style="display:block">
                        ...
                        <div class=" slider_bt" style="position: absolute;margin: 13px 1px 1px 33px;display:none;">
                            ...
                            <div id="slider-vertical" style="margin: -1px 4px 4px 68px;"></div>
                        </div>
                        <div class=" slider_bt" style="position: absolute;margin: 167px 1px 155px 33px;display:none;">
                            <span style="width:54px;float:left;font-family:verdana;">Zoom</span>
                            <div id="zoom-slider" style="margin: -1px 4px 4px 68px;"></div>
                        </div>
                        @endif
                    </div>
                    <div id="zoom_bt" class="ds_tool_group ds_border_left right" style="display:none">
                        <div class="ds_button" onclick="zoomInImage()">
                            <div class="ds_button_icon"><span class="glyph zoom-in"></span></div>
                            <div class="ds_button_name">Zoom in</div>
                        </div>
                        <div class="ds_button" onclick="zoomOutImage()">
                    ...
                    <div id="upload_bt" class="ds_tool_group ds_border_right" style="">
                        <div id="dsbt_upload" class="ds_button dsbt {{ Session::has('user_ip')?'':'ds_active' }} ">
                            <div class="ds_button_icon" style="color:red;"><i class="fa fa-fw fa-upload"></i></div>
                            <div class="ds_button_name">Upload</div>
                        </div>
                        <div id="dsbt_my_upload" class="ds_button dsbt  {{ Session::has('user_ip')?'ds_active':'' }}">
                            <div class="ds_button_icon" style="color:green;"><i class="fa fa-fw fa-picture-o"></i></div>
                            <div class="ds_button_name">My upload</div>
                        </div>
                        <div id="dsbt_layout_size" class="ds_button dsbt">
                        ...
                        <div id="dsbt_style" class="ds_button dsbt">
                        ...
                        <div id="dsbt_frame_depth" class="ds_button dsbt">
                        ...
                        <div id="dsbt_border" class="ds_button dsbt">
                        ...
                        ?>
                        @if( $optionShow > 0 )
                        <div id="dsbt_option" class="ds_button dsbt">
                            <div class="ds_button_icon"><i class="fa fa-fw fa-list-ul"></i></div>
                            <div class="ds_button_name">Options</div>
                        </div>
                        @endif
                        @endif
                    </div>
                    <div id="image_bt" class="ds_tool_group ds_border_right" style="display:none">
                        ...
                        <div class="ds_button"  onclick="rotateFrame()">
                ...
                <div class="content" style="display:table;">
                    <div class="left_content">
                        ...
                        <div id="content_upload" class="content_list" style=" {{ Session::has('user_ip')?'display:none':'display:table' }} ;width:100%;">
                            ...
                            <div id="import_image" class="row" style="margin-top:20px;">
                                    <h3>From:</h3>
                                    ...
                                    <div class="large-6 columns" >
                                            <img id="import_fb" src="/assets/images/social_icon/button-facebook.png" alt="" style="width:100%;" alt="Facebook" title="Facebook">
                                    </div>
                                    @endif
                                    @if(isset($arr_socail_id['flickr']))
                                    <div class="large-6 columns" >
                                            <img id="import_flickr" src="/assets/images/social_icon/button-flickr.png" alt="" style="width:100%;" alt="Flickr" title="Flickr">
                                    </div>
                                    @endif
                                    @if(isset($arr_socail_id['dropbox']))
                                    <div class="large-6 columns" >
                                            <img id="import_dropbox" src="/assets/images/social_icon/button-dropbox.png" alt="" style="width:100%;" alt="Dropbox" title="Dropbox">
                                    </div>
                                    @endif
                                    @if(isset($arr_socail_id['googledrive']))
                                    <div class="large-6 columns" >
                                            <img id="import_googledrive" src="/assets/images/social_icon/button-googledrive.png" alt="" style="width:100%;" alt="Goole Drive" title="Goole Drive">
                                    </div>
                                    <!-- <div class="large-6 columns" >
                                    ...
                                    <div class="large-6 columns" >
                                            <img id="import_skydrive" src="/assets/images/social_icon/button-skydrive.png" alt="" style="width:100%;" alt="Skydrive or Onedrive" title="Skydrive or Onedrive">
                                    </div>
                                    @endif
                                    @if(isset($arr_socail_id['instagram']))
                                    <div class="large-6 columns" >
                                            <img id="import_instagram" src="/assets/images/social_icon/button-instagram.png" alt="" style="width:100%;" alt="Instagram" title="Instagram">
                                    </div>
                                    @endif
                        ...
                        <!-- My Upload -->
                        <div id="content_my_upload" class="content_list content_3column" style="{{ Session::has('user_ip')?'display:table':'display:none' }}">
                        ...
                        <div id="content_layout_size" class="content_list" style="display:none;">
                            <table class="full_width">
                                ...
                                <tbody>
                                    ...
                                    <tr @if( !$product['custom_size'] ) style="display: none;" @endif>
                                        <td align="left">
                                            Width<input type="text" class="custom_size" name="custom_width" id="custom_width" value="{{$size_default[0]}}" style="text-align:right;" onchange="customSize(this)" />
                                            Heigth<input type="text" class="custom_size" name="custom_height" id="custom_height" value="{{$size_default[1]}}" style="text-align:right;" onchange="customSize(this)" />
                                        </td>
                            ...
                            ?>
                                <div id="bleed_{{$key2}}" class="step3-options" style="display: block;">
                                    ...
                                    <ul>
                                        ...
                                        <li class="col2">
                                            <div class="float-L thumb-img item_{{$key2}}"></div>
                                            <p class="price"></p>
                                        </li>
                                    </ul>
                                    </label>
                ...
                <div id="preview_box" style="display:none;">
                    ...
                    <button onclick="closePreview();" style="margin-top:15px;">Close</button>
                </div>
                <div class="footer">
                    ...
                    <div class="final_name">
                        ...
                        <button class="btn btn-success right" onclick="addCart();" style="margin-top: -39px;"> {{ isset($svgInfo['cart_id']) ? 'Update' : 'Add to' }} cart </button>
                    </div>
                </div>
            </div>
        </article>
