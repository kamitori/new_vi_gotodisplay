                    ...
                    <table class="table table-striped table-hover table-bordered" id="list-product">
                        <thead>
                            <tr role="row" class="heading">
                                ...
                                <th class="text-center">Layout type</th>
                                <th class="text-center">SVG layout</th>
...
var columnDefs = [
        ...
        ,
        {
            ...
            "className" : "text-center",
            "data" : function(row, type, val, meta) {
                return '<img style="max-height: 110px;max-width:150px;" src="'+ row[9] +'" />';
            }
        },
        {
            "targets": 10,
            ...
            "data" : function(row, type, val, meta) {
                ...
                return '<a href="javascript:void(0)" class="xeditable-select" data-escape="true" data-name="active" data-type="select" data-value="'+row[10]+'" data-pk="'+row[1]+'" data-url="{{ URL.'/admin/products/update-product' }}" data-title="Active">'+html+'</a>';
            }
        },
    ];
listRecord({
