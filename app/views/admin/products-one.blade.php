							...
							<div class="tab-pane" id="images">
								...
								<tbody>
		                            ...
		                            <tr role="row" class="{{ $i%2 == 0 ? 'even' : 'odd' }}" data-id="{{ $key }}">
		                                ...
		                                <td data-id="{{ $key }}">
		                                    ...
		                                    <div class="fileinput fileinput-new" data-provides="fileinput">
		                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
		                                            ...
		                                            @else
		                                            <img data-image-origin="{{public_path()}}/{{$file}}" data-origin-src="{{ URL::asset( 'assets/images/noimage/247x185.gif' ) }}" src="{{ URL::asset( 'assets/images/noimage/247x185.gif' ) }}" alt=""/>
		                                            @endif
		                                        </div>
		                                ...
		                                <td class="text-center">
		                                	<select class="form-control main_image" name="images[{{ $key }}][main]">
		                                		<option value="0">---Select---</option>
		                                		<option value="1" {{ $main ? 'selected' : '' }} >Main image</option>
		                                		<option value="2" {{ $back ? 'selected' : '' }} >3D Back image</option>
		                                		<option value="3" {{ $square ? 'selected' : '' }} >Square back image</option>
		                                		<option value="4" {{ $bg2d ? 'selected' : '' }} >2D Background image</option>
		                                	</select>
		                                </td>
		                                <td class="text-center">
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<div class="row">
												...
												<div class="col-md-4">
													<a class="btn btn-primary col-md-3" data-toggle="tooltip" title="Add new Layout" href="{{ URL }}/admin/layouts/add-layout" target="_blank"><i class="fa fa-plus"></i></a>
													<a id="edit-layout" class="btn green-meadow col-md-3" data-toggle="tooltip" title="Edit current Layout" href="{{ URL }}/admin/layouts/edit-layout/0" target="_blank"><i class="fa fa-edit"></i></a>
												</div>
											</div>
										</div>
									</div>
...
function create_drop_list_main_image(){
	$(".main_image").select2({
		allowClear: true,
...
function addImage()
{
    ...
    var html = [
            '<tr role="row" class="'+className+'" data-id="'+key+'">',
                ...
                '</td>',
                '<td class="text-center">',
                	'<select class="form-control main_image" name="images['+key+'][main]" value="'+key+'">',
						'<option value="0">---Select---</option>',
                		'<option value="1">Main image</option>',
                		'<option value="2">3D Back image</option>',
                		'<option value="3">Square back image</option>',
                		'<option value="4">2D Background image</option>',
                	'</select>',
                "</td>",
                '<td  class="text-center">',
                    '<a class="btn btn-primary red btn-delete-button btn-sm" onclick="deleteRow(this)" href="javascript:void(0);" title="Delete"><i class="fa fa-times"></i>Delete </a>',
