			...
			<div class="portlet-body">
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="col-md-12" id="banner-big">
							<div class="portlet box red tab-pane">
								<div class="portlet-title">
									<div class="caption">
										<i class="fa fa-reorder"></i>{{ 'Big Banner' }}
									</div>
									<div class="tools">
										<a href="javascript:;" class="fullscreen">
										</a>
								...
								<div class="portlet-body form">
									<form id="update-banner-big" action="{{ URL.'/admin/menus/update-banner/big' }}"  method="POST" class="form-horizontal" role="form">
										<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>"/>
										<div class="form-body">
											<input type="hidden" id="mid" name="mid" value="0">
											@foreach($arrBigBanners as $key => $banner)
											<div class="form-group">
												<div class="col-md-1">
													<div class="checkbox-list">
														<label class="checkbox-inline">
															<input type="checkbox" id="banner-selected-{{ $banner['id'] }}" name="banner-selected[]" value="{{ $banner['id'] }}" />
														</label>
													</div>
												</div>												
												<div class="col-md-3 text-center">
													<img src="{{ URL.'/'.$banner['image'] }}" height="50px"/>
												</div>
												<div class="col-md-8">
													<span>{{ $banner['name'] }}</span>
												</div>
												<div class="col-md-11 col-md-offset-1" style="margin-top: 20px">
													@foreach($arr_list_big_banner as $key => $val)
														<a target="_blank" href="{{$val['link']}}"><b>{{$val['name']}}</b></a> , 
													@endforeach
												</div>
											</div>
											@endforeach
											<div class="form-actions">
												<div class="row">
													<div class="col-md-offset-3 col-md-9">
														<button type="submit" class="btn green">Update Big Banner</button>
														<button type="button" id="cancel" class="btn default">Cancel</button>
													</div>
												</div>
											</div>	
						...
						<div class="col-md-12" id="banner-small">
							<div class="portlet box red tab-pane">
								<div class="portlet-title">
									<div class="caption">
										<i class="fa fa-reorder"></i>{{ 'Small Banner' }}
									</div>
									<div class="tools">
										<a href="javascript:;" class="fullscreen">
										</a>
								...
								<div class="portlet-body form">
									<form id="update-banner-small" action="{{ URL.'/admin/menus/update-banner/small' }}"  method="POST" class="form-horizontal" role="form">
										<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>"/>
										<div class="form-body">
											<input type="hidden" id="mid" name="mid" value="0">
											@foreach($arrSmallBanners as $key => $banner)
											<div class="form-group">
												<div class="col-md-1">
													<div class="checkbox-list">
														<label class="checkbox-inline">
												...
												<div class="col-md-11 col-md-offset-1" style="margin-top: 20px">
													@foreach($arr_list_small_banner as $key => $val)
														<a target="_blank" href="{{$val['link']}}"><b>{{$val['name']}}</b></a> , 
													@endforeach
												</div>
											</div>
											...
											<div class="form-actions">
												<div class="row">
													<div class="col-md-offset-3 col-md-9">
														<button type="submit" class="btn green">Update Small Banner</button>
														<button type="button" id="cancel" class="btn default">Cancel</button>
													</div>
												</div>
											</div>	
...
function editMenu(id)
{
	...
	//check banners selected
	$("#mid", '#banner-big').val(info["id"]);
	$("#mid", '#banner-small').val(info["id"]);
	$('input[name="banner-selected[]"]').prop("checked", false);
	$('input[name="banner-selected[]"]').parent().removeClass("checked");
	var banners;
	if(info["big_banners"] != null){
		banners = info["big_banners"].split(",");
		for(i in banners){
			$('#banner-selected-'+banners[i], '#banner-big').prop("checked", true);
			$('#banner-selected-'+banners[i], '#banner-big').parent().addClass("checked");
		}
	}
	if(info["small_banners"] != null){
		banners = info["small_banners"].split(",");
		for(i in banners){
			$('#banner-selected-'+banners[i], '#banner-small').prop("checked", true);
			$('#banner-selected-'+banners[i], '#banner-small').parent().addClass("checked");
		}
	}
